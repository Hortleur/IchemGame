...
<section class=" my-8">
    <div id="formation" class=" h-20"></div>
        ...
        <details class=" border-b-2 border-base-300 py-2 px-1 gap-2 lg:hover:shadow-lg hover:cursor-pointer lg:w-5/12 lg:mx-auto">   
            ...
            <div>
                <h3 class=" font-semibold">Prérequis d'entrée en formation: </h3>
                    <ul class=" ml-2">
                        <li class=" list-item"> - Disposer d’une expertise métier sur laquelle animer une séquence de formation.</li>
                        <li class=" list-item"> - Une expérience professionnelle de 3 ans est souhaitée.</li>
                    </ul>
                <h3 class=" font-semibold">Prérequis techniques :</h3>
                <p class=" ml-2">Disposer d’un ordinateur ou d’une tablette équipée d’une Webcam et avoir accès à réseau Internet haut débit pour les séances prévues à distance en Visio-conférence.</p>
            </div>
        </details>
        <details class=" border-b-2 border-base-300 py-2 px-1 gap-2 lg:hover:shadow-lg hover:cursor-pointer lg:w-5/12 lg:mx-auto">   
            <summary class="  font-bold text-lg">Objectifs pédagogiques</summary>
            <div class=" pl-3 flex flex-col flex-nowrap gap-2 ">
                <ul>
                    <li> - Appréhender les techniques, les outils, les modalités et compétences nécessaires pour transmettre à un ou plusieurs apprenants un savoir ou un savoir-faire.</li>
                    <li> - Gérer les situations sensibles avec agilité et sensibilité</li>
                    <li> - Délivrer le bon contenu dans un bon timing</li>
                    <li> - Conduire une action de formation en utilisant des techniques de communication (verbale ou non), de questionnement et d’écoute active</li>
                    <li> - Créer des situations de feedback avec l’apprenant</li>
                </ul>
            </div>
        </details>
        <details class=" border-b-2 border-base-300 py-2 px-1 gap-2 lg:hover:shadow-lg hover:cursor-pointer lg:w-5/12 lg:mx-auto">   
            <summary class="  font-bold text-lg">Public concerné</summary>
            <div class=" pl-3 flex flex-col flex-nowrap gap-2 ">
                <p>La certification s’adresse à des professionnels détenant des compétences spécifiques à leurs métiers, et sollicités afin de transmettre leurs pratiques à des collègues, collaborateurs ou clients dans le cadre d’animation ponctuelle de formation.</p>
            </div>
        </details>
        <details class=" border-b-2 border-base-300 py-2 px-1 gap-2 lg:hover:shadow-lg hover:cursor-pointer lg:w-5/12 lg:mx-auto">   
            <summary class="  font-bold text-lg">Durée de Formation</summary>
            <div class=" flex flex-row flex-nowrap items-center justify-center font-bold">
                <p class=" mr-2 text-accent">42</p> 
                <Icon icon="svg-spinners:clock" />
            </div>
            <div class=" pl-3 flex flex-col flex-nowrap gap-2 ">
                Cette formation se déroulera sur 6 semaines avec 2 sessions de 3h30 par semaine en comptant le travail personnel. 
            </div>
        </details>
        <details class=" border-b-2 border-base-300 py-2 px-1 gap-2 lg:hover:shadow-lg hover:cursor-pointer lg:w-5/12 lg:mx-auto">   
